...
<section class="data" style="background: white !important; width: 100%; min-height: 100vh;">
    ...
    <div class="history">
        ...
        <div class="history-item">
            ...
            <p class="title">Permasalahan & Kategori Permasalahan :</p>
            <p>Permasalahan status tanah jl. palap kendari dengan TNI AD (witel sultra)</p>
            <p class="title">Ringkasan Permasalahan* :</p>
            <p>Permasalahan status tanah jl. palap kendari dengan TNI AD (witel sultra)</p>
            <p class="title">Progress Penanganan & Rencana Tindak Lanjut*** :</p>
            <p>Permasalahan status tanah jl. palap kendari dengan TNI AD (witel sultra)</p>
            <p class="title">Isu Penting :</p>
            <p>Permasalahan status tanah jl. palap kendari dengan TNI AD (witel sultra)</p>
        </div>
        <br>
        <div class="history-item">
